...
- 14.07 Demo (mit Carina Schuch) gelaufen; Team (operative Seite) ist überzeugt: Preis fair im Vergleich,
  Modultiefe hat überrascht. Konrad verhandelt weiter selbst ("ich verhandele alles").
- Diskussion um Stundenpreis/Paket: Philipps Vorschlag — Kontingent von 100h für 10% Rabatt kaufen.
  Konrad unzufrieden mit reiner Stundenpreis-Erklärung ("mir bringt das so wenig", "Angebot muss von
  euch erklärt werden") — will klareres Angebot von OBS.
- 17.07 Weitere Beratungstermine bei OBS verfügbar (odoo-bs.com Buchungsseite, je 1,5h). Konrad wollte
  "Montag 15 Uhr", aber der Slot war schon weg, bevor gebucht werden konnte. Philipp riet zum Anruf
  (schneller als bis Mittwoch auf den nächsten Online-Slot zu warten) oder alternativ 30 Min. Kein
...
- **31.07 — Einordnung (Philipp):**
  - **OBS/Stefan Arens ist Konrads Thema** — nicht bei Philipp, kein Nachfassen von seiner Seite nötig.
  - **Intero/Uli Kessel: Philipp lässt das bewusst noch etwas liegen ("pokern")**, solange die OBS-Verhandlung
