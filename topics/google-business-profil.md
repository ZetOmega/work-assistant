...
- **24.07 (Teams Celine)**: Celine fragt nach dem **Google-Business-Account bzw. den Login-Daten**.
  **Max und Marv brauchen den Zugang „recht dringend"**.
- Philipp ist dran, aber **Google stellt sich quer**: im Konto ist eine **unbekannte Telefonnummer** hinterlegt
  (Philipp kennt sie nicht und hat sie nicht gefunden). Philipp: „ohne diese Nummer wird es ewig dauern" —
  der Support-Weg über Google dauert vermutlich **mehrere Wochen** (Antwortzeiten von Tagen).
